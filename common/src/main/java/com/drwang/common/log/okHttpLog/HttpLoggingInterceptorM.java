package com.drwang.common.log.okHttpLog;


import android.os.Looper;
import android.util.Log;

import com.drwang.common.log.LogUtil;
import com.drwang.common.log.LogUtilHelper;
...
public final class HttpLoggingInterceptorM implements Interceptor {
    ...
    public Response intercept(Chain chain) throws IOException {
        ...
        logger.log("Thread name " + Thread.currentThread().getName() , LogUtil.D);
        logger.log("Thread name 2" + Looper.getMainLooper().getThread().getName(), LogUtil.D);
